...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707147645
...
cp %{_builddir}/user-agents-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-user_agents/67889d1b621a75a20266ff60118d4e11f734f7db || :
